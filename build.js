...
var DataActions = _reflux2['default'].createActions(['fetchData']);
...
var _componentsHeaderComponent = require('./components/headerComponent');

var _componentsHeaderComponent2 = _interopRequireDefault(_componentsHeaderComponent);

var _componentsPlayerComponent = require('./components/playerComponent');

var _componentsPlayerComponent2 = _interopRequireDefault(_componentsPlayerComponent);

var _actionsDataActions = require('./actions/DataActions');

var _actionsDataActions2 = _interopRequireDefault(_actionsDataActions);
...
var _componentsDetailComponent = require('./components/detailComponent');

var _componentsDetailComponent2 = _interopRequireDefault(_componentsDetailComponent);

_actionsDataActions2['default'].fetchData();

_react2['default'].render(_react2['default'].createElement(_componentsHeaderComponent2['default'], null), document.getElementById('header'));

_react2['default'].render(_react2['default'].createElement(_componentsPlayerComponent2['default'], null), document.getElementById('player-container'));

_react2['default'].render(_react2['default'].createElement(_componentsDetailComponent2['default'], null), document.getElementById('detail-container'));

},{"./actions/DataActions":1,"./components/detailComponent":3,"./components/headerComponent":4,"./components/playerComponent":5,"react":163}],3:[function(require,module,exports){
'use strict';
...
var DetailPlayer = _react2['default'].createClass({
    displayName: 'DetailPlayer',
    ...
    render: function render() {
        return _react2['default'].createElement(
            ...
            _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'progress',
                    { className: 'progress progress-striped progress-success ', value: '50', max: '100' },
                    '50%'
                )
            )
        );
...
},{"react":163,"reflux":179}],4:[function(require,module,exports){
'use strict';
...
},{"react":163,"reflux":179}],5:[function(require,module,exports){
'use strict';
...
var _storesDataStore = require('../stores/DataStore');

var _storesDataStore2 = _interopRequireDefault(_storesDataStore);

var PlayerComponent = _react2['default'].createClass({
    displayName: 'PlayerComponent',

    mixins: [_reflux2['default'].connect(_storesDataStore2['default'], 'playersData')],
                ...
                this.state.playersData.map(function (player) {
                    return _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            'div',
                            { className: 'col-md-4' },
                            _react2['default'].createElement('img', { src: player.picture, alt: 'Player picture', className: 'img-fluid' })
                        ),
                        _react2['default'].createElement(
                            'div',
                            { className: 'col-md-8' },
...
},{"../stores/DataStore":182,"react":163,"reflux":179}],6:[function(require,module,exports){
'use strict';
...
},{"eventemitter3":6}],176:[function(require,module,exports){
...
var DataStore = _reflux2['default'].createStore({
    ...
    sourceUrl: 'http://',
    listenables: [_actionsDataActions2['default']],
...
},{"../actions/DataActions":1,"jquery":7,"reflux":179}]},{},[2]);
